...
```{r, echo=F, message=F, warning=F, width="100%"}
knitr::include_graphics("exit-vim-meme.png")
```
</div>
...
```{r, echo=F, message=F, warning=F, width="100%"}
knitr::include_graphics("neovim-intro.png")
```
...
<div style = "float:left; position:relative; width: 38.2%; right: 10px; top: 0px;">
```{r, echo=F, message=F, warning=F, width="100%"}
knitr::include_graphics("neovim-help.png")
```
</div>
...
<div style = "float:right; position:relative; width: 38.2%; right: 10px; top: 0px;">
```{r, echo=F, message=F, warning=F, width="100%"}
knitr::include_graphics("neovim-new-here.png")
```
</div>
